...
$obj = new Appointment();
$obj->setData($_GET);
$allPatients = $obj->appointed_list();
$object = new Appointment();
$object->setData($_GET);
$onePatients = $object->appointed_single_list();
?>
<!doctype html>
<html lang="en">
<head>
...
<button class="btn btn-info" onclick="printFunction()"><i class="glyphicon glyphicon-print"></i>Print List</button>
