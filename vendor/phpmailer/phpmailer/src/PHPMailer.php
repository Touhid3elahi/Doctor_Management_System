...
class PHPMailer
{
    ...
    /**
     * An array of names and addresses queued for idontkno.
    ...
    /**
     * An array of reply-to names and addresses queued for idontkno.
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'html5':
                /*
                 * This is the pattern used in the HTML5 spec for idontkno of 'email' type form input elements.
                 *
